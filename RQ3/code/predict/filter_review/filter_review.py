...
class ClaReview(DataProcessor):
    ...
    def read_txt(self, data_dir, flag):
        ...
        if flag == "train":
            ...
            # lines = lines[0:25170]
            # lines = lines[0:545159]
            # lines = lines[0:884123]
            # lines = lines[0:880461]
            # lines = lines[0:665219]
            # lines = lines[0:734463]
            # lines = lines[0:401610]
            # lines = lines[0:44868]
            lines = lines[0:22620]     # zoom

        return lines

    def get_train_examples(self, data_dir):
        return self._create_examples(
            self.read_txt(os.path.join(data_dir, "zoom_train.txt"), "train"), "train")
            

    def get_dev_examples(self, data_dir):
        return self._create_examples(
            self.read_txt(os.path.join(data_dir, "zoom_val.txt"), "dev"), "dev")

    def get_test_examples(self, data_dir):
        return self._create_examples(
                        self.read_txt(os.path.join(data_dir, "zoom.test.txt"), "test"), "test")
...
def main(_):
    ...
    if FLAGS.do_predict:
        ...
        with tf.gfile.GFile(output_predict_file, "w") as writer:
            with open("review/zoom_for_predict.txt", 'r', encoding='utf-8') as f:
                lines = f.readlines()
                # lines = lines[0:25170]
                # lines = lines[0:545159]
                # lines = lines[0:884123]
